document.addEventListener('DOMContentLoaded', () => {
  var images_url = document.getElementById("random-images-url");
  if (images_url) {
    var images = images_url.getAttribute("data").split(" ");
    var time_counter = 10;
    var image_counter = 0;
...
function addPlays() {
  ...
  xmlhttp.send("play[time_count]=" + timer + "&play[image_url]=" + image + "");
}
